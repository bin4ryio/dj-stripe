    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', djstripe.fields.StripeCharField(choices=[('duplicate', 'Duplicate'), ('fraudulent', 'Fraudulent'), ('requested_by_customer', 'Requested by customer')], help_text='Reason for the refund.', max_length=21, null=True)),
